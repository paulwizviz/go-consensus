...
This is a collection of consensus algorithm implemented in Go.

## Content

* [Crash Fault Tolerence](./cft/doc.md)
...
Copyright 2024 The Contributors to go-consensus
...
For a list of contributors, refer to the CONTRIBUTORS file or th